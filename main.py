...
def next_():
	...
	show_result = ScrolledText(root,wrap="none", bd=1, bg="#b7f7ab", fg="black")
...
def chooseFile():
	...
	openBtnImage = PhotoImage(file = "E:\\Code-Tester-main\\Code-Tester-main\\open1.png")
	...
	label = Label(root, text = "open correct solution to test (.cpp only)", font = buttonFont, bg = "#b7f7ab", fg = "grey")
	...
	label = Label(root, text = "open  bruteforce solution to check (.cpp only)", font = buttonFont, bg = "#b7f7ab", fg = "grey")
	...
	label2 = Label(root, text = "open test case generator(.cpp only)", font = buttonFont, bg = "#b7f7ab", fg = "grey")
...
def main2():
	...
	root.title("CodeTester")
	root.resizable(0,0)

	# openImage = PhotoImage(file = "images/roorbg.png")
	label = Label(root, bg = '#b7f7ab', width = 120, height = 80)
